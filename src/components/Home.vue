  ...
  <div class="home-view">
    ...
    <div class="section is-medium">
      ...
      <p>
        ...
        track them, or work with your friends/family and keep each other
        accountable. The main problem with habit forming/habit breaking is the
        lack of accountability. This app helps to achieve accountability,
        whether used solo or with a partner or group.
      </p>
    </div>
  </div>
</template>